...
//------------------------------------------
// 어떤 digit에 출력할지 선택하는 모듈
// 1ms마다 fnd를 display하기 위해서 digit 1자리씩 선택하는 logic
// 4ms까지는 잔상 효과가 있다. 그 이상의 시간 지연을 주면 깜빡임 현상 발생 주의 요함
//------------------------------------------
...
//---------------------------------------
// in_data : 14bit fnd에 9999 까지 표현하기 위한 bin size
// 0~9999 천/백/십/일 자리수 0~9까지 BCD로 4bit 표현
//---------------------------------------
